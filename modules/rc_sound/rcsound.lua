SOUNDS_CONFIG = {
	...
	checkInterval = 500,
	folder = 'music/',
	noSound = 'Area Sem Som.',
}

SOUNDS = {
	-- Saffron E Outras Cidades
	...
	{fromPos = {x=1581, y=1507, z=6}, toPos = {x=1665, y=1540, z=6}, sound = "Winter-Alleys.ogg"},
	{fromPos = {x=1611, y=1541, z=7}, toPos = {x=1666, y=1597, z=7}, sound = "Winter-Alleys.ogg"},
	{fromPos = {x=1611, y=1541, z=6}, toPos = {x=1666, y=1597, z=6}, sound = "Winter-Alleys.ogg"},
	{fromPos = {x=1551, y=1541, z=7}, toPos = {x=1595, y=1599, z=7}, sound = "Winter-Alleys.ogg"},
	{fromPos = {x=1551, y=1541, z=6}, toPos = {x=1595, y=1599, z=6}, sound = "Winter-Alleys.ogg"},
	{fromPos = {x=1596, y=1554, z=7}, toPos = {x=1610, y=1598, z=7}, sound = "Winter-Alleys.ogg"},
	{fromPos = {x=1596, y=1554, z=6}, toPos = {x=1610, y=1598, z=6}, sound = "Winter-Alleys.ogg"},
	{fromPos = {x=1621, y=1660, z=7}, toPos = {x=1624, y=1679, z=7}, sound = "cidade 1.ogg"},
	{fromPos = {x=1621, y=1660, z=6}, toPos = {x=1624, y=1679, z=6}, sound = "cidade 1.ogg"},
	{fromPos = {x=1585, y=1662, z=7}, toPos = {x=1675, y=1739, z=7}, sound = "cidade 1.ogg"},
	{fromPos = {x=1585, y=1662, z=6}, toPos = {x=1675, y=1739, z=6}, sound = "cidade 1.ogg"},
	{fromPos = {x=1762, y=1532, z=7}, toPos = {x=1830, y=1607, z=7}, sound = "lavender.ogg"},
	{fromPos = {x=1762, y=1532, z=6}, toPos = {x=1830, y=1607, z=6}, sound = "lavender.ogg"},
	-- Inicio Do Game
